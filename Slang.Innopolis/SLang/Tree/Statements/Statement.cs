...
namespace SLang
{
    ...
    public class BODY : STATEMENT, iSCOPE
    {
        ...
        public void add ( ENTITY e ) { this.addEntity(e); }
        ...
        /// <code>
        /// Составной-оператор
        /// 	: [Предусловие] do Вложенный-составной-оператор end
        ///
        ...
        ///
        /// Условный-оператор
        /// 	: if Выражение ( then | [Предусловие] do )
        /// 	    Вложенный-составной-оператор
        ///     { Elsif-часть }
        ///     [ Else-часть ]
        ///       end
        ///       
        /// Elsif-часть
        /// 	: elsif Выражение ( then | [Предусловие] do )
        /// 	     Вложенный-составной-оператор
        /// 	     
        /// Else-часть
        /// 	: else [ Предусловие do ] Вложенный-составной-оператор
        /// 	
        /// Оператор-цикла
        /// 	: [Метка-цикла] Заголовок-цикла
        /// 	        [Предусловие] ( loop | do ) Вложенный-составной-оператор end
        ///     | [Метка-цикла]
        ///             [Предусловие] loop Вложенный-составной-оператор end
        ///
        /// Объявления-и-операторы
        /// 	: abstract
        /// 	| foreign
        /// 	| none
        /// 	| Объявление-или-оператор { Объявление-или-оператор }
        ///
        ...
        ///
        /// Реакции-на-исключения
        /// 	: Реакция { Реакция } [Else-часть]
        ///
        /// Реакция
        /// 	: when Ситуация { | Ситуация }
        /// 	          ( => | [Предусловие] do ) Вложенный-составной-оператор
        /// </code>
        /// </summary>
        /// <param name="stop1"></param>
        /// <param name="stop2"></param>
        /// <param name="stop3"></param>
        /// <param name="context"></param>
