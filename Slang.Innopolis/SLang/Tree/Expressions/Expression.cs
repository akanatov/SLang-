...
namespace SLang
{
        ...
        public static new EXPRESSION parse(Token first, iSCOPE context)
        {
            ...
            switch ( token.code )
            {
                case TokenCode.This:
                    ...
                    if ( unit == null ) // illegal position of 'this'
                        error(token,"illegal-this");
    ...
    public class CONDITIONAL : PRIMARY
    {
        ...
        public static EXPRESSION parse(iSCOPE context)
        {
            ...
            EXPRESSION condition = EXPRESSION.parse(token, context);
    ...
    public class THIS : PRIMARY
    {
        ...
        public override void report(int sh)
        {
            System.Console.Write(commonAttrs() + shift(sh) + "THIS");
            if( unit != null ) System.Console.WriteLine(": " + unit.unique);
        ...
        public static new EXPRESSION parse ( Token first, iSCOPE context )
        {
            ...
            switch (token.code)
            {
                ...
                case TokenCode.New:
                    ...
                    break;
                default:
                    result = SECONDARY.parse(token,context);
